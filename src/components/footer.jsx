  ...
  return (
    ...
    < div className="container mx-auto flex justify-center">
      ...
      <div className="w-1/4 mx-auto mt-2 px-10">
        ...
        <button className='bg-yellow-button text-white py-2 my-2 px-4 rounded-full hover:bg-yellow-button-hover text-xs cursor-pointer'>Réserver en ligne</button><br></br>
      ...
      <div className="container text-center w-1/4 mx-auto mt-2 px-10">
        ...
        <button className='cursor-pointer bg-green-button text-white py-2 my-2 px-4 rounded-full hover:bg-green-button-hover text-xs'>Aller sur Google</button>
      </div>
      < div className="container text-center w-1/4 mx-auto mt-2 px-10">
